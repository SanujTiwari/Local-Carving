    ...
    if (empty($name) || empty($address) || empty($city) || empty($phone) || empty($category)) {
        ...
        if (empty($error)) {
            $stmt = $pdo->prepare("
                ...
                (owner_id, name, description, address, city, phone, email, category, opening_time, closing_time, logo_path) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
                ...
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Upload a logo image (JPG, PNG, or GIF)</div>
                        </div>
